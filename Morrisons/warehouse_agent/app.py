"""app.py — FastAPI service for the Warehouse Agent."""
...
logger = logging.getLogger("warehouse_agent.app")

app = FastAPI(title="Morrisons Warehouse Agent", version="1.0.0")
...
class ChatResponse(BaseModel):
    response:   str
    session_id: str
    agent:      str = "warehouse_agent"


@app.get("/health")
def health():
    return {"status": "ok", "agent": "warehouse_agent", "version": "1.0.0"}
