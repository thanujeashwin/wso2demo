"""app.py — FastAPI service for the Inventory Agent."""
...
logger = logging.getLogger("inventory_agent.app")

app = FastAPI(title="Morrisons Inventory Agent", version="1.0.0")
...
@app.get("/health")
def health():
    return {"status": "ok", "agent": "inventory_agent", "version": "1.0.0"}
