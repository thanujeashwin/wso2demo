...
# ---------------------------------------------------------------------------
# GatewayLLM — google-genai SDK routed through WSO2 AI gateway
# ---------------------------------------------------------------------------


class GatewayLLM:
    """
    Uses google-genai SDK with WSO2 AI gateway as the base URL.
    The API key is sent via the 'API-Key' header; Authorization is cleared
