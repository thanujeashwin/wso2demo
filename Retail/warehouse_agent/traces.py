"""traces.py — OpenTelemetry instrumentation for the Warehouse Agent."""
...
logger  = logging.getLogger("warehouse_agent.traces")
_tracer = trace.get_tracer("warehouse_agent", "1.0.0")
